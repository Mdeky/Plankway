...
const en = {
  ...
  'howto.5': 'All islands must form one connected network. An orange flag means that group is cut off from the rest.',
  'howto.controls':
    'Drag from one island to another to build a bridge. Drag again for a double bridge. Tap a bridge to remove it. You can also tap an island and then a neighbour. Keyboard: arrows to move, space to pick an island, then an arrow to build; Ctrl+Z undoes.',
...
const nl: Record<MessageKey, string> = {
  ...
  'howto.5': 'Alle eilanden moeten samen één verbonden netwerk vormen. Een oranje vlag betekent: die groep ligt afgesneden van de rest.',
  'howto.controls':
    'Sleep van een eiland naar een ander om een brug te leggen. Nog eens slepen geeft een dubbele brug. Tik op een brug om ze weg te halen. Je kan ook op een eiland tikken en daarna op een buur. Toetsenbord: pijltjes om te bewegen, spatie om een eiland te kiezen, dan een pijltje om te bouwen; Ctrl+Z maakt ongedaan.',
